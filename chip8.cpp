...
bool chip8::setupGraphics() {
  ...
  window = new Window("Bo's Chip8 Emulator", 23, 1472, 736);
  return !window->isClosed();
}

// TODO: See if I really do not need this function
/*
...
void chip8::emulateCycle() {
  ...
  case 0x2000:
	...
	// TODO: Double check to be sure this opcode was implemented properly
  ...
  case 0x8000:
	...
	case 0x000E:
	  ...
	  V[0xF] = (V[(opcode >> 8) & 0xF] & 0b10000000) >> 7;
  ...
  case 0xF000:
	...
	case 0x000A:
	  ...
	  // TODO: Check to see if the pollEvent function that is called in setKeys actually blocks
	  setKeys();
	...
	case 0x0009:
	  ...
	  // TODO: Check to make sure this was implemented propery
...
void chip8::drawGraphics() {
  SDL_Rect** pixelArray = window->getPixelArray();

  for (int i = 0; i < (64 * 32); i++) {
	if (gfx[i] == 1) {
	  SDL_SetRenderDrawColor(window->getRenderer(), 255, 255, 255, 255);
	  std::cout << "Rect White" << std::endl;
	} else {
	  SDL_SetRenderDrawColor(window->getRenderer(), 0, 0, 0, 255);
	}
	SDL_RenderFillRect(window->getRenderer(), pixelArray[i]);
  }
}

void chip8::setKeys() {
  SDL_Event* theEvent = window->pollEvents();
